import omniscriptRestApiUtilsForCore from 'c/omniscriptRestApiUtilsForCore';
 ...
 * @returns {String}
 */
function replaceUrlHost(originalUrl, bCommunity, communityName, communityBaseUrl) {
    let type = 'resource';
    let url = originalUrl;
    ...
    if (bCommunity && (/livepreview/.test(window.location.host) || /live-preview/.test(window.location.host))) {
