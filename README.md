# Omniscript Assistant Agent
This project includes Lightning Web Components that override the standard Step Chart element in an Omniscript and replaces it with an Agent.  
