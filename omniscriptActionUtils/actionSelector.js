...
export function initializeAction(actionType, actionDef) {
    ...
    const actType = actionType.replace('Raptor', 'Mapper');
    ...
    switch (actType) {
        ...
        case 'Integration Procedure Action':
            ...
            break;
        case 'DataMapper Turbo Action': // Bleed through and use DR Extract
        case 'DataMapper Extract Action':
            actionUtilClass = new OmniscriptDrExtractActionUtil(actionDef);
            break;
        case 'DataMapper Transform Action':
            actionUtilClass = new OmniscriptDrTransformActionUtil(actionDef);
            break;
        case 'DataMapper Post Action':
