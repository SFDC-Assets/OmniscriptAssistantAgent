...
export class OmniscriptDocusignEnvelopeActionUtil extends OmniscriptBaseActionUtil {
     ...
     *              in preProcess. Handles preprocessed Promise data as a result of createDataMapperPromise.
     * @param {Promise} data
     * @param {*} comp
    ...
    docusignAction(payload, element, comp) {
        ...
        // no error was found in getDataFromDocusignTemplate, call DataMappers
        return this.createDataMapperPromise(control, input, comp);
    }

    //Create DataMapper promise
    createDataMapperPromise(control, input, comp) {
